...
In this document, we provide a brief a tutorial on how to use the P-GBME model detailed in ["Modeling Asymmetric Relationships from Symmetric Networks"](https://arxiv.org/abs/1711.03838). The P-GBME model can be run by first sourcing in a set of R functions that are contained in the `pgbme.R` script -- in the future, we may wrap P-GBME into its own package or incorporate it into the [AMEN framework](https://arxiv.org/abs/1611.00460): 
